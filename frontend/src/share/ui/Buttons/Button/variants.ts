...
const buttonVariants = cva(
	...
	),
	{
		variants: {
			variant: {
				primary: cn(
					"bg-primary-60 text-base-180 hover:bg-primary-80",
					"disabled:text-base-120 disabled:bg-base-160",
				),
				secondary: cn(
					"bg-base-160 text-base-0 hover:bg-base-150",
					"disabled:text-base-120 disabled:bg-base-160",
				),
				outline: cn(
