...
type TourInformation = Pick<DetailTour, "category" | "pregnant_possible" | "child_price" | "what_age_child_free">
		...
		<Section title={t("pages.detailTour.information.title")}>
			<ul className='flex flex-col gap-2'>
				<li className='flex items-center gap-1'>
					...
					/>
					<Typography variant='contentPrimary'>{tour.category}</Typography>
				</li>
				<li className='flex items-center gap-1'>
					<Icon
						name='Baby'
