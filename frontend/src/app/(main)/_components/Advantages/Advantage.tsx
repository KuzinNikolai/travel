  ...
  return (
    <li className="flex min-w-[194px] flex-col gap-2 rounded-lg bg-background p-3">
      <div className="flex flex-row items-center gap-2">
        ...
        <Typography variant="h3" as="h3" textWidth="semibold" className="content-center hyphens-manual text-lg">
          {advantage.title}
        </Typography>
      </div>
      <Typography variant="content1" textWidth="light" className="text-primary-400">
