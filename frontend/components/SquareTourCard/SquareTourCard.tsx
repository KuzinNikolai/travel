...
export const SquareTourCard = ({ appearance, children, title, meta_desc, description, duration, min_price, image, href, className, photo, photos, average_rating, ...props }: SquareTourCardProps): JSX.Element => {
    return (
